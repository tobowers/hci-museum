...
`)+`
`+p;let A=x+d+s,T=x+p+o,P=Bl(r,r.VERTEX_SHADER,A),C=Bl(r,r.FRAGMENT_SHADER,T);if(r.attachShader(w,P),r.attachShader(w,C),i.index0AttributeName!==void 0)r.bindAttribLocation(w,0,i.index0AttributeName);else if(i.morphTargets===!0)r.bindAttribLocation(w,0,"position");r.linkProgram(w);function I(E){if(e.debug.checkShaderErrors){let G=r.getProgramInfoLog(w)||"",j=r.getShaderInfoLog(P)||"",F=r.getShaderInfoLog(C)||"",W=G.trim(),O=j.trim(),H=F.trim(),Z=!0,ne=!0;if(r.getProgramParameter(w,r.LINK_STATUS)===!1)if(Z=!1,typeof e.debug.onShaderError==="function")e.debug.onShaderError(r,w,P,C);else{let me=zl(r,P,"vertex"),Ae=zl(r,C,"fragment");Ie("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(w,r.VALIDATE_STATUS)+`
