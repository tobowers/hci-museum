...
const exhibitData: Exhibit[] = [
  ...
  },
  {
    ...
    subtitle: "The triangular console where form IS the interface — rotate the whole machine to switch from steering wheel to light gun to paddles.",
    blurb: "The Coleco Telstar Arcade (1977) was a triangular dedicated home console where the physical shape defined the interaction. Each of the three sides housed a completely different control surface: paddle dials for Pong-style games, a light gun in a holster for shooting, and a steering wheel with gear shift for driving. To switch games, you rotated the entire 16-inch, 4-pound console. Triangular cartridges plugged into the top — each containing its own MOS MPS-7600 microcontroller, making this one of the earliest systems where the CPU lived in the cartridge rather than the console. Designed by Sanders Associates engineers under Ralph Baer's supervision. Only four cartridges were released.",
    tags: ["Dedicated Console", "Input Device", "Embodied Interaction", "1970s"],
    image: img("telstar-arcade-paddle.jpg"),
  },
  {
    id: "editdroid",
    slug: "editdroid",
    wikiTitle: "Lucasfilm EditDroid",
    year: "1984",
    sortYear: 1984,
    title: "Lucasfilm EditDroid",
    subtitle: "The non-linear editing system that invented the timeline — built by Lucasfilm's computer division, bought by no one, sold to Avid.",
    blurb: "The EditDroid (1984) introduced the visual grammar of all modern non-linear editing: the horizontal timeline, picture icons for clips, and the three-panel Source/Program/Timeline layout. At its heart was the TouchPad — a custom physical controller with a KEM-style jog/shuttle knob that replicated Steenbeck flatbed editing muscle memory, a trackball, and 12 context-sensitive LED-labeled soft keys that dynamically relabeled for each editing task. Only 24 units were made at $150,000 each by George Lucas's The Droid Works. The same computer division that birthed EditDroid would become Pixar. The technology was sold to Avid in 1993, and the EditDroid's interface DNA lives on in every NLE since.",
    tags: ["Creative Workstation", "Input Device", "Multimedia", "Film Editing", "Professional"],
    image: img("editdroid-console.jpg"),
  },
  {
    id: "atari-puffer",
    slug: "atari-puffer",
    wikiTitle: "Atari Puffer",
    year: "1983",
    sortYear: 1983,
    title: "Atari Puffer",
    subtitle: "The unreleased exercise bike that made you pedal to play — Atari's 1983 exergaming prototype, canceled weeks before its Olympic launch.",
    blurb: "Project Puffer (1983) was Atari's secret attempt to merge video games with the fitness craze. Developed by the Corporate Research Group under Alan Kay, it turned an exercise bike into a game controller: a Hall effect sensor read wheel speed (no pedaling, no motion), handlebar-mounted buttons provided steering, and an optional heart-rate monitor tracked exertion. Four custom games were built, including the first-person desert ride Tumbleweeds and the paddleboat sim Jungle River Cruise. Atari planned Pro, Arcade, and Home ($150) models, with internal marketing targeting 68% female buyers. The 1983 crash and Atari's sale to the Tramiels killed it weeks before its planned 1984 Olympics tie-in launch — two decades before Wii Fit made the concept a hit.",
    tags: ["Exergaming", "Input Device", "Embodied Interaction", "Prototype", "Physiological Computing"],
    image: img("atari-puffer-controller.jpg"),
  },
];
