...
const exhibitData: Exhibit[] = [
  ...
  },
  {
    ...
    wikiTitle: "Flute Playing Machine (1979–1982)",
    year: "1979–1982",
    sortYear: 1980,
    title: "Flute Playing Machine",
    subtitle: "draw a music roll with felt-tip pens; photocells read it and a robot plays an acoustic alto flute",
    blurb: "An electro-mechanical instrument by Berlin-based British artist Martin Riches that lets users compose music by drawing with felt-tip pens on a transparent music roll. Fifteen photocells read the hand-drawn markings and operate 12 electromagnetic keys on a specially-made alto flute, plus an air valve from a soundproofed blower. First exhibited at Künstlerhaus Bethanien Berlin in 1980, it toured internationally for five years before being acquired by the Berlinische Galerie. Composers including Tom Johnson wrote works specifically for the machine. Unlike UPIC (Xenakis, 1977) which drove a synthesizer, this machine uses optical sensing to drive an acoustic instrument with solenoids and compressed air.",
    tags: ["HCI", "Input", "Music", "Drawing", "Tangible", "Installation"],
    image: img("flute-playing-machine-fpmc.jpg"),
  },
  {
    id: "jhu-serial-code-keyboard",
    slug: "jhu-serial-code-keyboard",
    wikiTitle: "Johns Hopkins Serial Code Keyboard (1983)",
    year: "1983",
    sortYear: 1983,
    title: "Johns Hopkins Serial Code Keyboard",
    subtitle: "a three-position switch that ditches Morse timing for tone frequency — dits and dahs are equal duration, differentiated by pitch",
    blurb: "An accessibility input device developed at Johns Hopkins Applied Physics Lab that uses a frequency-encoded pseudo-Morse principle. A three-position spring-centered switch connects to the Apple II game port: left produces high-frequency 'dits,' right produces low-frequency 'dahs,' both equal duration. Unlike real Morse code, timing is irrelevant — frequency is the sole differentiator. The system translates tone sequences to ASCII, implementing four keyboard modes. Published in Creative Computing (October 1983) by Wolfger Schneider. The user literally hears their own keystrokes as musical pitches — a direct auditory-kinesthetic coupling.",
    tags: ["HCI", "Input", "Accessibility", "Morse", "Apple II"],
    image: img("jhu-serial-code-keyboard-cc1983.jpg"),
  },
  {
    id: "mouse-systems-optical-mouse",
    slug: "mouse-systems-optical-mouse",
    wikiTitle: "Mouse Systems Optical Mouse (1982)",
    year: "1982",
    sortYear: 1982,
    title: "Mouse Systems Optical Mouse",
    subtitle: "the first mouse for the IBM PC required a printed metal pad — without it, the mouse was dead weight",
    blurb: "The first commercially successful optical mouse and the first mouse for the IBM PC, designed by Steve Kirsch and manufactured by Mouse Systems Corporation (Fremont, CA). Two LEDs pulse through a spherical lens, bounce off a mirror on the top lid, and hit photodetectors that count the lines crossed on a reflective aluminum grid pad. The pad was not an accessory — it was half the sensing system. Without it, the mouse was nonfunctional. Different models used different grid densities (M4: 200 CPI, M5: 300 CPI). Bundled as the standard pointing device for Sun workstations through the 1980s. The pad-coupling made the interaction space physically bounded and visible — a fundamentally different paradigm from surface-agnostic modern mice.",
    tags: ["HCI", "Input", "Pointing", "Optical", "Mouse"],
    image: img("mouse-systems-optical-mouse-1.jpg"),
  },
];
