...
const exhibitData: Exhibit[] = [
  ...
  {
    id: "maltron-keyboard",
    slug: "maltron-keyboard",
    sortYear: 1977,
    wikiTitle: "Maltron Keyboard",
    year: "1977",
    title: "Maltron Keyboard",
    subtitle: "Two concave key wells your hands fall into — the keyboard as a physical theory about hands",
    blurb: "Where most keyboard redesigns rearrange the legends, Maltron rearranged the keys in space: two concave key bowls, keys staggered to finger length, thumbs given real keys, wrist pronation engineered out of the plastic. Designed by Lillian Malt from 1974, hand-built since 1977, and the ancestor of every sculpted keyboard.",
    tags: ["Input", "Keyboard", "Ergonomics", "Physical Design", "Accessibility"],
    image: img("maltron-keyboard-1.jpg"),
  },
  {
    id: "gyration-gyropoint",
    slug: "gyration-gyropoint",
    sortYear: 1991,
    wikiTitle: "Gyration GyroPoint",
    year: "1991",
    title: "Gyration GyroPoint",
    subtitle: "The mouse you wave in the air — a spinning flywheel turned wrist rotation into cursor movement",
    blurb: "The first gyroscopic mouse: a brushless motor spins a gravity-aligned flywheel inside the unit, optical encoders read its pitch and roll, and the cursor follows your wrist gesture. No desk, no pad, no receiver array. Shipped by Gyration in 1991, fifteen years before the Wii Remote's inertial trick.",
    tags: ["Input", "Pointing", "Gesture", "Inertial Sensing", "Wireless"],
    image: img("gyration-gyropoint-1.png"),
  },
  {
    id: "canon-rc-701",
    slug: "canon-rc-701",
    sortYear: 1986,
    wikiTitle: "Canon RC-701 Still Video Camera",
    year: "1986",
    title: "Canon RC-701 Still Video Camera",
    subtitle: "The first filmless camera you could buy — analog pictures on a magnetic floppy you watched on TV",
    blurb: "The Canon RC-701 (1986) wrote CCD images as analog video fields onto a 2-inch magnetic floppy: 50 stills per disk, played back on a television through a dedicated player, printable via video printer or captured by frame grabber. USA Today shot the 1986 World Series with one. Filmless imaging, TV-shaped, before consumer digital.",
    tags: ["Image Capture", "Analog Computing", "Media", "Consumer"],
    image: img("canon-rc-701-1.jpg"),
  },
];
