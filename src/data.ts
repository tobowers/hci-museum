...
const exhibitData: Exhibit[] = [
  ...
  },
  {
    ...
    subtitle: "Draw with felt-tip pens and a robot plays an acoustic alto flute",
    blurb: "An electro-mechanical instrument by Martin Riches that lets users compose music by drawing with felt-tip pens on a transparent music roll. A row of 15 photocells reads the hand-drawn markings as the roll advances through the machine, and the amplified signals operate 12 electromagnetic keys on a specially-made alto flute, plus control an air valve from a soundproofed blower. The audience sees the hand-drawn marks before they are heard. Composers including Tom Johnson wrote works for it. In the permanent collection of the Berlinische Galerie.",
    tags: ["Music", "Drawing", "Robot", "Installation", "Tangible"],
  ...
  },
  {
    ...
    blurb: "An accessibility input device from Johns Hopkins Applied Physics Lab that operates on frequency-encoded pseudo-Morse code. A three-position spring-centered switch connects to the Apple II game port: left generates high-frequency tones (dits), right generates low-frequency tones (dahs), both equal duration. The user literally hears their own keystrokes as musical pitches — the tones ARE the encoding. Unlike real Morse, timing is discarded entirely. Published in Creative Computing (October 1983) and evaluated at rehabilitation centers across North America for users unable to use standard keyboards.",
    tags: ["Accessibility", "Morse", "Frequency-encoded", "Apple II", "Input"],
    image: img("jhu-serial-code-keyboard-1.jpg"),
  },
  {
    id: "midi-dance-floor",
    ...
    subtitle: "A 32-foot dance floor with 128 force-sensing resistors — nuanced body pressure becomes live music and video",
    blurb: "A continuous-pressure dance interface developed at the University of Texas at Austin that treats the entire floor as a musical instrument. Unlike the NES Power Pad (binary rubber switches) and Stompin' (3×3 arcade grid), the MIDI Dance Floor uses 128 Force Sensing Resistors hidden beneath a professional Marley dance surface, arranged in an 8×8 grid yielding 64 two-foot-square zones. Each zone transmits continuous analog pressure and position data as MIDI messages. Used with Merce Cunningham Dance Studio dancers — weight transfers, speed, and pressure gradients become expressive musical and video parameters. Published in the Journal of the Acoustical Society of America (1990).",
    tags: ["Dance", "Pressure", "Music", "MIDI", "Whole-body", "Embodied"],
