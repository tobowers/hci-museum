...
const exhibitData: Exhibit[] = [
  ...
  },
  {
    ...
    blurb: "The Flute Playing Machine is an electro-mechanical instrument that lets users compose music by drawing with felt-tip pens on a transparent music roll. Fifteen photocells read the hand-drawn markings and drive twelve electromagnetic keys on a specially-made alto flute plus a compressed air blower. A drawing-to-acoustic-sound interface — unlike UPIC's drawing-to-synthesizer — that was acquired by the Berlinische Galerie museum after touring internationally. Composers including Tom Johnson wrote works for it; visitors at the Musée d'Art Moderne de la Ville de Paris could draw their own music rolls and immediately hear the result.",
    tags: ["Music", "Drawing", "Tangible", "Robot", "Installation"],
  ...
  },
  {
    ...
    subtitle: "A three-position switch that replaces Morse timing with tone frequency — dits and dahs are equal duration, differentiated by pitch",
    blurb: "An accessibility input device developed at Johns Hopkins Applied Physics Lab that operates on a frequency-encoded pseudo-Morse principle. Unlike real Morse code where dahs are three times longer than dits, this system makes dits and dahs equal duration — differentiated solely by tone frequency (high for dits, low for dahs). The user moves a three-position spring-centered switch connected to the Apple II game port. The system translates tone sequences to ASCII, implementing four keyboard modes. Published in Creative Computing magazine (October 1983) and evaluated in rehabilitation centers across the US and Canada.",
    tags: ["Input", "Accessibility", "Morse", "Apple II"],
  ...
  },
  {
    ...
    sortYear: 1978,
    title: "EDP Wasp",
    subtitle: "A $199 synthesizer with a flat capacitive touch keyboard — no moving parts, just skin capacitance and a vinyl sticker",
    blurb: "One of the earliest consumer products to use capacitive touch as its primary input modality, the EDP Wasp replaced mechanical piano keys with flat copper plates hidden under a silk-screened vinyl sticker. Notes were triggered by skin capacitance alone — no moving parts, no tactile feedback. Musicians found they could glide across the surface at speeds impossible on mechanical keys, but also that sweat triggered false notes, humidity caused runaway droning, and the absence of physical key travel frustrated traditional keyboardists. The Deluxe variant (only ~80 units) reverted to a mechanical keyboard — an explicit concession that capacitive touch wasn't enough for expressive musical performance.",
    tags: ["Capacitive Touch", "Music", "Synthesizer", "Input"],
    image: img("edp-wasp-main.jpg"),
  },
];
