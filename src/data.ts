...
const exhibitData: Exhibit[] = [
  ...
  },
  {
    ...
    sortYear: 1985,
    title: "Teddy Ruxpin",
    subtitle: "The animatronic bear whose cassette tapes carried audio for the child and servo commands for the machine",
    blurb: "Ex-Disney Imagineer Ken Forsse miniaturized theme-park animatronics into a plush toy bear in 1985. Stereo cassette tapes carried the story audio on the left channel and pulse-position modulation servo data on the right — nine pulses per frame controlled three servo motors animating the bear's eyes and jaw. The child heard a story. The bear received a robot control program. Worlds of Wonder sold over a million units in six months, and the bear is held by the V&A, Powerhouse Museum, and Computer History Museum.",
    tags: ["Animatronics", "Toy", "Robot", "Embedded Systems"],
    image: img("teddy-ruxpin-vam.jpg"),
  },
  {
    id: "tron-intelligent-house",
    slug: "tron-intelligent-house",
    wikiTitle: "TRON Intelligent House",
    year: "1989",
    sortYear: 1989,
    title: "TRON Intelligent House",
    subtitle: "The house was the interface — ~1,000 computers in the walls, windows, toilets, and kitchens of a Tokyo home built two years before \"ubiquitous computing\" had a name",
    blurb: "Completed in December 1989 by Ken Sakamura and a consortium of 18 Japanese companies, the TRON Intelligent House embedded approximately 1,000 networked computers into a 333m² Tokyo residence. A health-monitoring toilet performed automatic urinalysis and sent results to a doctor. Roof-mounted weather sensors opened and closed motorized windows. Motion detectors tracked occupants for lighting and HVAC. A kitchen dispensed seasonings in milligram units and replayed recorded recipes. Real families lived there for three years, providing HMI feedback. Cost: ~US$20 million. Recognized as IEEE Milestone #263 in 2024.",
    tags: ["Ubiquitous Computing", "Smart Environment", "IoT", "Ambient Intelligence"],
    image: img("tron-house-exterior.jpg"),
  },
  {
    id: "wisard",
    slug: "wisard",
    wikiTitle: "WISARD Pattern Recognition Machine",
    year: "1981",
    sortYear: 1981,
    title: "WISARD Pattern Recognition Machine",
    subtitle: "A 302kg cabinet that recognized your face using RAM chips instead of neurons — face-as-interface in 1981",
    blurb: "Built at Brunel University in 1981, WISARD (Wilkie, Stonham, and Aleksander's Recognition Device) was one of the world's first hardware neural network computers. Instead of simulating weighted synapses, it used banks of RAM chips where each cell was simply a 1 or a 0 — a 'weightless' neural network that ran at 30 fps on 1981 hardware. Present your face to the TV camera, and the 302 kg cabinet decided whether it had seen you before. Evaluated by the UK Home Office for covert surveillance. On display at the Science Museum, London.",
    tags: ["Neural Network", "Face Recognition", "Computer Vision", "AI"],
    image: img("wisard-cabinet.jpg"),
  },
];
