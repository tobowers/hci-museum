...
const exhibitData: Exhibit[] = [
  ...
  {
    id: "icl-one-per-desk",
    slug: "icl-one-per-desk",
    wikiTitle: "ICL One Per Desk / BT Merlin Tonto",
    year: "1984",
    sortYear: 1984,
    title: "ICL One Per Desk",
    subtitle: "The desktop computer with a built-in telephone handset",
    blurb: "The ICL One Per Desk (1984) was a British personal computer that was also a telephone — literally. A telephone handset sat in a cradle molded into the side of the case. Pick it up to make calls; the computer managed voice/data switching, auto-answered with speech synthesis, and stored directories. Powered by a Motorola 68008 CPU with 128KB RAM and dual Microdrives. Built by ICL with Sinclair Research and BT, it was sold as the Merlin Tonto (\"The Outstanding New Telecoms Opportunity\"). Described as a \"wildly visionary product\" — a smartphone concept two decades early, at desktop scale.",
    tags: ["Telephony", "Computer", "Phone", "Network"],
    image: img("icl-one-per-desk-1.webp"),
  },
  {
    ...
    subtitle: "The telephone that showed faces, in color, over ordinary phone lines",
    blurb: "The AT&T VideoPhone 2500 (1992) was the first mass-market consumer video telephone. A 3.3-inch color LCD screen, video camera, and standard telephone handset — all in one $1,499 device that worked over ordinary analog phone lines at 2-10 frames per second. The culmination of AT&T's 65-year video telephone quest, from the 1927 ikonophone through the 1964 Picturephone. Like all its predecessors, it was a commercial failure — but the physical paradigm of talking-and-seeing on a single device eventually became universal with FaceTime and smartphones.",
    tags: ["Telephony", "Video", "Consumer", "Display"],
    image: img("att-videophone-2500-1.jpg"),
  },
  {
    id: "datacopy-model-700",
    slug: "datacopy-model-700",
    wikiTitle: "Datacopy Model 700",
    year: "1985",
    sortYear: 1985,
    title: "Datacopy Model 700",
    subtitle: "The first flatbed scanner for the IBM PC, and the birth of a physical ritual",
    blurb: "The Datacopy Model 700 (1985) was the first flatbed scanner for the IBM PC. Lift lid, place document face-down on glass, close lid, click scan — this physical ritual, repeated billions of times across three decades of office life, was first crystallized by this machine. Built by Datacopy Corporation (Palo Alto) with Ricoh hardware, scanned at 200 dpi in 1-bit monochrome via CCD. The company never achieved sustained profitability and was acquired by Xerox in 1988 for $31 million. The flatbed scanner form factor outlived the company by decades.",
    tags: ["Scanner", "Input", "Document", "Imaging"],
    image: img("datacopy-model-700-1.png"),
  },
];
