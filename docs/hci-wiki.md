...
1. [Hubot (c. 1983)](#hubot-c-1983)
2. [The P300 Speller (1988)](#the-p300-speller-1988)
3. [VPL Research EyePhone & DataGlove (1980s)](#vpl-research-eyephone--dataglove-1980s)
4. [Put-That-There (1980)](#put-that-there-1980)
5. [VIDEOPLACE / Artificial Reality (1970s–80s)](#videoplace--artificial-reality-1970s80s)
6. [Nintendo Power Glove (1989)](#nintendo-power-glove-1989)
7. [Olivetti Active Badge (1992)](#olivetti-active-badge-1992)
8. [The Digital Desk (1991)](#the-digital-desk-1991)
9. [Atari Mindlink (1984)](#atari-mindlink-1984)
...
51. [Minsky Sandpaper / Computational Haptics Sandpaper System (1990)](#minsky-sandpaper--computational-haptics-sandpaper-system-1990)
52. [Quantel Paintbox (1981)](#quantel-paintbox-1981)
53. [Tongue Touch Keypad (TTK) / Tongue Activated Communications Controller (1991)](#tongue-touch-keypad-ttk--tongue-activated-communications-controller-1991)
...
110. [Entex Adventure Vision (1982)](#entex-adventure-vision-1982)
...
* **Origins and team.** Hubotics Inc. was a small Carlsbad, California startup formed to build a personal home robot named Hubot. Mechanical/graphic designer Glen Keith hand-built early prototypes in his home, carving the rotating sensor head from plastic and fiberglass.
* **Hardware.** Hubot stood roughly 1.10 m tall and moved on wheels. It contained a proprietary CP/M-class computer (one source names SysCon), a monochrome monitor, a detachable keyboard, printer support, joystick control, a 12-inch display, a TV tuner, a cassette deck and an Atari 2600.
* **Sensing and speech.** A Polaroid-style ultrasonic transducer mounted on a rotating collar scanned the room for obstacles before movement. An optional voice-command module with a built-in microphone allowed limited spoken control; the voice synthesizer could speak about 1,200 words in English.
* **Launch and price.** The robot was demonstrated at the January 1984 Consumer Electronics Show (CES). It was priced at US$3,495 (well over US$10,000 in 2026 dollars). Planned optional modules included a fire/burglar alarm, a robotic arm, a drink tray, a vacuum unit, route programming, and autonomous recharging.
* **Commercial fate.** The project was too expensive and too far ahead of its ecosystem to succeed at scale. Production estimates vary; one Reddit post claims roughly 75 units were made, but this is a single-source figure and should be treated cautiously.
* **Weird / fun facts.** Hubot’s body was rotomolded in polyethylene — the same material used for trash cans and water tanks — because it was cheap, rugged and still looked good after scratches. Its head used the same sonar sensor found in Polaroid cameras. Today a Hubot is preserved in the Computer History Museum’s collection.
...
![Hubot, Hubotics, c.1981/83](../assets/wiki/hubot-cnet.webp)
*CNET gallery photo of Hubot, captioned “Hubot, Hubotics, 1981.” Source: [CNET](https://www.cnet.com/pictures/rise-of-the-robots-from-sci-fi-to-our-homes/)*

![Hubot hardware detail](../assets/wiki/hubot-hardware.webp)
*Hardware.com.br photo showing Hubot’s display and Atari 2600 slot. Source: [Hardware.com.br](https://www.hardware.com.br/tecnologia/hubot-robo-atari-1984/)*

![Hubot being carried](../assets/wiki/hubot-sciencephoto.jpg)
*Science Photo Library image of Hubot being held from behind. Source: [Science Photo Gallery](https://sciencephotogallery.com/featured/hubot-robot-volker-steger.html?product=acrylic-print)*
...
2. American Computer and Robotics Museum, “Hubot: A Personal History and Reminiscence” — https://acrmuseum.org/hubot-history
...
---
## The P300 Speller (1988)

**By:** Lawrence A. Farwell & Emanuel Donchin  
**Tags:** `Brain Control` `BCI` `EEG` `P300` `Assistive Technology`
...
* **Publication.** Farwell and Donchin described the system in “Talking off the top of your head: toward a mental prosthesis utilizing event-related brain potentials,” *Electroencephalography and Clinical Neurophysiology* 70(6):510–523, 1988.
* **The P300 signal.** The P300 is a positive EEG deflection that peaks roughly 300 ms after an infrequent, attended “oddball” stimulus. In the speller, this signal is elicited whenever the row or column containing the user’s target character flashes.
* **Row-column paradigm.** A 6×6 grid displays the alphabet plus digits. Rows and columns flash in random order; the user silently counts flashes that include the desired character. The row and column producing the largest P300 responses are identified, and their intersection gives the selected character.
* **Performance.** The original report used a stepwise linear discriminant analysis (SWLDA) classifier, tested on four subjects, and achieved about 95% accuracy at roughly 12 bits/min information transfer rate.
* **Notable experiments / demos.** Farwell and Donchin’s paper demonstrated that people could spell without any overt muscle movement. Later work introduced the checkerboard paradigm, region-based spellers, auditory/tactile variants, hybrid P300+SSVEP systems, and, most recently, LLM-augmented P300 spellers such as ChatBCI.
...
* **Weird / fun facts.** The paper’s title coined the phrase “talking off the top of your head.” Modern descendants literally pair the speller with large language models to predict words and cut the number of required selections by up to 80%.
...
![P300 row-column paradigm](../assets/wiki/p300-rowcolumn.webp)
*Row-column paradigm figure from the 2022 Frontiers review (open access). Source: [Frontiers in Human Neuroscience](https://www.frontiersin.org/journals/human-neuroscience/articles/10.3389/fnhum.2022.1077717/full)*

![First page of the 1988 P300 speller paper](../assets/wiki/p300-paper-01.png)
*First page of the original Farwell & Donchin (1988) scanned paper. Source: [Farwell Brain Fingerprinting](https://www.farwellbrainfingerprinting.com/pdf/Farwell-Donchin-1988-Talking-Off-the-Top-of-Your-Head-BCI-brain-computer-interface.pdf)*
...
---
## VPL Research EyePhone & DataGlove (1980s)

**By:** Jaron Lanier, Thomas G. Zimmerman and colleagues at VPL Research  
**Tags:** `VR` `Gesture` `Wearables` `HMD` `Commercial VR`
...
* **Company.** VPL stood for “Virtual Programming Languages.” The company was founded in Palo Alto by Lanier and Thomas G. Zimmerman after they left Atari; early funding came in part from Marvin Minsky. VPL filed for bankruptcy in 1990, and its patents were bought by Sun Microsystems in 1998/1999.
...
* **DataSuit and RB2.** The DataSuit extended full-body motion capture. “Reality Built for Two” (RB2) let two people share a virtual world, making it an early commercial networked-VR system.
...
![VPL DataSuit](../assets/wiki/vpl-datasuit.jpg)
*VPL Research DataSuit on display (Wikimedia Commons). Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/VPL_Research)*

![EyePhone and DataGlove demo, 1989](../assets/wiki/vpl-eyephone-demo.jpg)
*Two people demonstrating EyePhone and DataGlove at the Texpo Telecommunications Show, San Francisco, June 1989. Source: [Flashbak](https://flashbak.com/jaron-laniers-eyephone-head-and-glove-virtual-reality-in-the-1980s-26180/)*

![Jaron Lanier](../assets/wiki/vpl-jaron-lanier.jpg)
*Jaron Lanier, VPL co-founder. Source: [Flashbak](https://flashbak.com/jaron-laniers-eyephone-head-and-glove-virtual-reality-in-the-1980s-26180/)*
...
**Tags:** `Voice` `Gesture` `Multimodal` `Graphics Interface`
...
* **Publication.** The work was presented at SIGGRAPH ’80 as “Put-that-there: Voice and gesture at the graphics interface.” MIT’s Media Lab publication page also hosts the paper PDF.
* **Design philosophy.** The project explicitly assumed that speech-recognition hardware would never be 100% accurate. To raise “effective accuracy,” it combined voice, gesture, syntax, semantics, context-sensitive interpretation, immediate visual feedback, and spoken clarification questions.
* **Interaction.** Users referred to objects and locations deictically: “Create a blue square there,” “Put that below that,” etc. The system asked aloud when input was ambiguous, making the conversation loop visible and correctable.
...
* **Impact.** Put-That-There is a foundational reference for multimodal HCI. It inspired decades of research on gesture+speech input and is still revisited today; a 2025 arXiv paper proposes “Revisiting put-that-there” for modern head-mounted displays using large language models.
...
![Put-That-There SIGGRAPH '80 title page](../assets/wiki/put-that-there-paper-1.png)
*Title page of the scanned SIGGRAPH ’80 paper. Source: [MIT Media Lab](https://dam-prod.media.mit.edu/uuid/8e6d934b-6c6f-48e4-b0a1-270e0dae745f)*

![Put-That-There demo thumbnail](../assets/wiki/put-that-there-video.jpg)
*YouTube thumbnail from the original demo recording. Source: [YouTube](https://www.youtube.com/watch?v=RyBEUyEtxQo)*
...
---
## VIDEOPLACE / Artificial Reality (1970s–80s)

**By:** Myron Krueger  
**Tags:** `Gesture` `Artificial Reality` `Interactive Art` `Computer Vision` `Telepresence`
...
* **Origins.** Krueger established the Videoplace laboratory in the mid-1970s, first at the University of Wisconsin and later at the University of Connecticut. It grew out of earlier installations: GLOWFLOW (1969), METAPLAY (1975), and PSYCHIC SPACE.
* **No-wearable philosophy.** Krueger deliberately avoided goggles and gloves. His goal was an artificial reality that surrounded users and responded to their natural body movements.
...
* **Notable experiments / demos.** Users could push, pull, or play with virtual creatures and objects. Because they saw their silhouettes on screen, they experienced social presence: people instinctively pulled away when their silhouettes intersected with another person’s.
* **Legacy.** The work formed the basis of Krueger’s influential 1983 book *Artificial Reality*. VIDEOPLACE is now on permanent display at the State Museum of Natural History at the University of Connecticut.
...
![Videoplace still](../assets/wiki/videoplace-mediaartnet.jpg)
*Myron Krueger, *Videoplace*, 1974 video still. Source: [Media Art Net](http://www.medienkunstnetz.de/works/videoplace/)*

![Videoplace 1989 demo thumbnail](../assets/wiki/videoplace-video.jpg)
*YouTube thumbnail from “Myron Kreuger – Video Place – 1989.” Source: [YouTube](https://www.youtube.com/watch?v=dqZyZrN3Pl0)*
...
**By:** Abrams/Gentile Entertainment / Mattel (technology licensed from VPL Research)  
**Tags:** `Gesture` `Wearable` `Gaming` `Motion Control` `Virtual Reality`
...
* **Technical details.** The glove was worn on the right hand and contained:
  ...
  * Ultrasonic transmitters/receivers to track hand roll and position in 3D space.
  * A keypad on the forearm with traditional NES buttons plus programmable buttons 0–9.
  * A serial connection to the NES.
* **Games.** Only two games were released specifically for the glove: *Super Glove Ball* and *Bad Street Brawler*. The glove appeared prominently in the 1989 film *The Wizard*, where Lucas Barton declares, “I love the Power Glove. It’s so bad.”
* **Impact.** Despite its commercial failure, the Power Glove is often cited as a precursor to later motion controllers (Wii Remote, PlayStation Move, Kinect) and as an early affordable entry point for hobbyist VR experiments. 1990s VR enthusiasts used the glove with shareware such as REND386.
* **Weird / fun facts.**
...
![NES Power Glove](../assets/wiki/power-glove-1.jpg)
*The American NES Power Glove, showing the forearm keypad and knuckle-mounted ultrasonic sensors. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Power_Glove)*

![Power Glove promotional art](../assets/wiki/power-glove-2.jpg)
*Promotional advertising imagery for the Power Glove, c. 1989. Source: [ACMI](https://www.acmi.net.au/stories-and-ideas/nintendo-nes-power-glove/)*

### Sources

1. Wikipedia, “Power Glove.” https://en.wikipedia.org/wiki/Power_Glove
2. ACMI, “The promise of the Nintendo Power Glove.” https://www.acmi.net.au/stories-and-ideas/nintendo-nes-power-glove/
3. Jake Rossen, “An Oral History of Nintendo's Power Glove,” Mental Floss, 22 Feb 2017. https://mentalfloss.com/article/91939/losing-their-grip-oral-history-nintendos-power-glove
4. HowStuffWorks, “How the Nintendo Power Glove Worked.” https://electronics.howstuffworks.com/nintendo-power-glove.htm
5. Design News, cover story, 4 Dec 1989 (PDF via Microsoft Research/Bill Buxton collection). https://research.microsoft.com/en-us/um/people/bibuxton/buxtoncollection/a/pdf/powerglove%20design%20news%20%20article.pdf

---
## Olivetti Active Badge (1992)

**By:** Roy Want, Andy Hopper, Veronica Falcão, Jonathan Gibbons — Olivetti Research Laboratory (ORL)  
**Tags:** `Wearable` `Location-Aware` `Ubiquitous Computing` `Context-Aware` `Infrared`
...
* **Background.** The Olivetti Research Laboratory was founded in 1986 by Hermann Hauser and Andy Hopper after Olivetti acquired Acorn Computers. The Active Badge was conceived, designed, and prototyped between 1989 and 1992.
* **Technical details.**
  * Each badge was a small wearable device that transmitted a unique infrared signal every 10 seconds.
  * Rooms were equipped with networked sensors that received these signals and forwarded them to a central location service.
...
* **Impact.** The Active Badge is widely cited as a foundational system for indoor localization, context-aware computing, and what later became known as sentient/ubiquitous computing. Follow-up work evolved into the Active Bat ultrasonic system and the broader Sentient Computing project.
* **Weird / fun facts.**
...
![Active Badge generations](../assets/wiki/active-badge-1.gif)
*Four generations of the Active Badge, showing the progression from 5-bit to 48-bit bidirectional designs. Source: [Cambridge/AT&T Active Badge archive](https://www.cl.cam.ac.uk/research/dtg/attarchive/ab.html)*

### Sources

1. Cambridge Computer Laboratory, “The Active Badge System.” https://www.cl.cam.ac.uk/research/dtg/attarchive/ab.html
2. Cambridge Computer Laboratory, “The Active Badge.” https://www.cl.cam.ac.uk/research/dtg/attarchive/thebadge.html
3. Roy Want, Andy Hopper, Veronica Falcão, Jonathan Gibbons, “The Active Badge Location System,” *ACM Transactions on Information Systems*, Jan 1992. https://www.roywant.com/cv/papers/pubs/1992-01%20(ACM%20TOIS)%20Active%20Badge.pdf
4. Wikipedia, “Olivetti Research Laboratory.” https://en.wikipedia.org/wiki/Olivetti_Research_Laboratory
5. Microsoft Research, “Location-Aware Computing Comes of Age,” *IEEE Computer*, 2004. https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/locationaware-ieeecomputer2004.pdf
6. YouTube, “The Active Badge System | ACM SIGCHI.” https://www.youtube.com/watch?v=-vQ48S1IVD4

---
## The Digital Desk (1991)

**By:** Pierre Wellner at Rank Xerox EuroPARC  
**Tags:** `Tangible Interface` `Augmented Reality` `Projection` `Computer Vision` `Office Work`
...
![Digital Desk prototype](../assets/wiki/digital-desk-1.gif)
*Early DigitalDesk prototype showing projected user-interface elements on the desktop surface. Source: [NAVER LABS Europe](https://europe.naverlabs.com/history/past-research/digitaldesk-to-camworks/)*

![Digital Desk CHI '92 video thumbnail](../assets/wiki/digital-desk-2.jpg)
*YouTube thumbnail for “Tactile Manipulation on a Digital Desk (1991) Xerox,” the CHI ’92 video demonstration. Source: [YouTube](https://www.youtube.com/watch?v=laApNiNpnvI)*

### Sources

1. Pierre Wellner, “The DigitalDesk Calculator: Tactile Manipulation on a Desk Top Display,” *UIST ’91 Proceedings*, pp. 27–33. https://uist.acm.org/archive/html/proceedings/1991.html
2. ACM Digital Library, DOI 10.1145/120782.120785. https://dl.acm.org/doi/pdf/10.1145/120782.120785
3. Pierre Wellner, “Interacting with Paper on the DigitalDesk,” University of Cambridge Technical Report UCAM-CL-TR-330, 1994. https://www.cl.cam.ac.uk/techreports/UCAM-CL-TR-330.pdf
4. Eindhoven University presentation slides, “The Digital Desk from Pierre Wellner in 1991.” https://rauterberg.employee.id.tue.nl/presentations/How-to-acquire-HCI-knowledge/tsld006.htm
5. NAVER LABS Europe, “DigitalDesk to CamWorks.” https://europe.naverlabs.com/history/past-research/digitaldesk-to-camworks/
6. YouTube, “Tactile Manipulation on a Digital Desk (1991) Xerox.” https://www.youtube.com/watch?v=laApNiNpnvI
7. YouTube, “Digital Desk” by Pierre Wellner, 1991. https://www.youtube.com/watch?v=S8lCetZ_57g

---
## Atari Mindlink (1984)

**By:** Atari, Inc.  
**Tags:** `Brain-Computer Interface` `Biofeedback` `Wearable` `Gaming` `Vaporware`
...
* **Technical details.**
  ...
  * An advanced lab prototype could reportedly control almost any Atari joystick-compatible software by strapping the headband to different muscle groups.
* **Notable experiments, demos, and games.** Three games were in development: *Bionic Breakthrough* (a *Breakout* clone), *Telepathy*, and *Mind Maze* (a pseudo-ESP card-guessing game). None were released. The 1984 Summer CES demo used simple Pong/Breakout-style software because the more advanced controller could not be finished in time.
...
* **Weird / fun facts.**
  ...
  * The day after the CES introduction, a representative of the Special Olympics approached Atari about developing sports software for disabled athletes; the project’s cancellation closed that opportunity.
...
![Atari Mindlink at National Videogame Museum](../assets/wiki/atari-mindlink-1.jpg)
*A Mindlink controller on display at the National Videogame Museum. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Atari_Mindlink)*

![Atari Mindlink prototype](../assets/wiki/atari-mindlink-2.jpg)
*Prototype Mindlink headband and hardware shown by the Atari Museum. Source: [Atari Museum](https://atarimuseum.ctrl-alt-rees.com/videogames/consoles/2600/mindlink.html)*

### Sources

1. Wikipedia, “Atari Mindlink.” https://en.wikipedia.org/wiki/Atari_Mindlink
2. Atari Museum, “The Atari Mindlink System.” https://atarimuseum.ctrl-alt-rees.com/videogames/consoles/2600/mindlink.html
3. Atari Compendium, “MindLink.” https://www.ataricompendium.com/game_library/prototypes/vcs/mindlink.html
4. Chris Scullion, “The Atari Mindlink and other outrageous controllers,” *Computer and Video Games*, 10 Mar 2014. https://www.cvg.com/453147/blog/the-atari-mindlink-and-other-outrageous-controllers/
5. T3, “20 Worst game accessories ever.” https://www.t3.com/features/20-worst-game-accessories-ever-1/mindlink-jpg
6. YouTube, “Atari Mindlink (Atari 2600) Commercial 1984.” https://www.youtube.com/watch?v=VgQ-nii_9OY
7. YouTube, “Anthony Jones, Atari UK; Atari Mindlink — interview.” https://www.youtube.com/watch?v=PqBuVLAEmzs

---
## Texas Instruments Speak & Spell (1978)

**By:** Texas Instruments  
**Tags:** `Voice` `Speech Synthesis` `Educational Toy` `Handheld` `Consumer Electronics`
...
* **Technical details.**
  ...
  * Phoneme data were stored on a pair of 128 Kbit PMOS ROMs — at the time the largest-capacity ROMs in use.
  * A professional speaker recorded the words; the recordings were processed in Dallas to drastically reduce the data rate to roughly 1,000 bits per second.
  * The device had a small vacuum fluorescent display (VFD) capable of showing 8 characters at a time.
...
* **Notable experiments and games.** Built-in games included *Say It*, *Mystery Word*, *Secret Code*, and *Letter*. Cartridge expansions included *Vowel Power*, *Super Stumpers*, *Mighty Verbs*, and an *E.T. the Extra-Terrestrial* tie-in module. The toy spawned companion products: Speak & Read (1980), Speak & Math (1980), and later Super Speak & Spell models.
* **Impact.**
...
![Original Speak & Spell](../assets/wiki/speak-spell-1.jpg)
*An American 1978-model Speak & Spell with raised chiclet keyboard. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Speak_%26_Spell_(toy))*

![Speak & Spell in CHM timeline](../assets/wiki/speak-spell-2.jpg)
*TI Speak & Spell as featured in the Computer History Museum timeline. Source: [Computer History Museum](https://www.computerhistory.org/timeline/ai-robotics/)*

### Sources

1. Wikipedia, “Speak & Spell (toy).” https://en.wikipedia.org/wiki/Speak_%26_Spell_(toy)
2. Computer History Museum, “Speak & Spell.” https://www.computerhistory.org/timeline/ai-robotics/
3. Computer History Museum, “Graphics & Games Timeline.” https://www.computerhistory.org/timeline/graphics-games/
4. IEEE Global History Network, “Milestones: Speak & Spell, the First Use of a Digital Signal Processing IC for Speech Generation, 1978.” http://www.ieeeghn.org/wiki/index.php/Milestones:Speak_%26_Spell,_the_First_Use_of_a_Digital_Signal_Processing_IC_for_Speech_Generation,_1978
5. Audrey Watters, “Speak & Spell: A Brief History,” Circuit Bent, 13 Mar 2020. https://circuit-bent.net/talking-teacher-circuit-bent/speak-spell-a-brief-history.html
6. Texas Instruments press release, “TI Talking Learning Aid Sets Pace for Innovative CES Introductions,” 11 June 1978. http://www.datamath.org/Speech/SpeaknSpell.htm
7. YouTube, “Speak & Spell (1978) Texas Instruments.” https://www.youtube.com/watch?v=B_bahLxKF_k
8. YouTube, “1978 Texas Instruments Speak & Spell.” https://www.youtube.com/watch?v=F65l31ZkZKw

---
## Kurzweil Reading Machine (1976)

**By:** Kurzweil Computer Products  
**Tags:** `Accessibility` `Assistive Technology` `OCR` `Text-to-Speech`
...
![Kurzweil Reading Machine](../assets/wiki/kurzweil-reading-machine-1.jpg)
*Promotional photo of the Kurzweil Reading Machine. Source: [Kurzweil Technologies](http://www.kurzweiltech.com/kcp.html)*

### Sources

1. Kurzweil Technologies, “Kurzweil Computer Products” — http://www.kurzweiltech.com/kcp.html
2. Wikipedia, “Ray Kurzweil” — https://en.wikipedia.org/wiki/Ray_Kurzweil
3. Wikipedia, “Reading machine” — https://en.wikipedia.org/wiki/Reading_machine
4. YouTube, “1980s THROWBACK: ‘STEVIE WONDER AND THE KURZWEIL READING MACHINE’” — https://www.youtube.com/watch?v=dPKGbGm6Fec
5. YouTube, “Kurzweil’s Revolutionary reading devices for the blind” — https://www.youtube.com/watch?v=g0jECuwrn_U

---
## Virtuality Arcade VR System (1990)

**By:** Virtuality Group (originally W Industries)  
**Tags:** `VR` `Arcade` `Gaming` `3D Graphics` `Multiplayer`
...
Dr. Jonathan Waldern developed early VR prototypes at Leicester Polytechnic/Loughborough University, including a 1986 stereoscopic “Roaming Caterpillar” system. W Industries refined several prototype pods before the fifth prototype became the basis of the commercial Virtuality 1000SU, launched at the Computer Graphics ’90 exhibition at Alexandra Palace, London, in November 1990.

The 1000 series was built around an Amiga 3000 with 4 MB RAM and a pair of Texas Instruments TMS34020-based graphics accelerators (one per eye). The Visette headset used two Panasonic LCD screens (372×250 per eye) derived from a camcorder accessory; because the screens were too heavy to mount directly in front of the eyes, they were placed at the sides and reflected into the lenses with mirrors. The stand-up 1000CS used a Polhemus magnetic tracking ring at waist height to track both the headset and the space joystick; the sit-down 1000SD used a cheaper Ascension tracker with a shorter range, acceptable because the player remained seated.

The arcade 1000CS shipped in 1991 with games including *Dactyl Nightmare* (a multiplayer arena shooter with a pterodactyl that snatched players), *Grid Busters*, *Hero*, and *Legend Quest*. The SD unit offered *Battlesphere*, *Exorex*, *Total Destruction*, *VTOL*, and *Flying Aces*. About 1,200 Virtuality arcade machines were in use before the company filed for bankruptcy in 1997.

* **Weird / fun facts.**
  * The “CS” suffix stood for “Cyberspace,” pure marketing for the early-1990s VR hype.
  * *Dactyl Nightmare* is sometimes cited as one of the first commercial networked first-person deathmatch games, predating *Doom*.
  * The headset mirrors were a literal workaround for overweight LCDs.
...
![Virtuality 1000CS stand-up pod](../assets/wiki/virtuality-1000cs-1.jpg)
*1991 Virtuality 1000CS stand-up arcade pod with Visette headset and space joystick. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Virtuality_(product))*

![Virtuality 1000SD sit-down unit](../assets/wiki/virtuality-1000sd-2.jpg)
*Sit-down 1000SD unit. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Virtuality_(product))*

![Dactyl Nightmare screenshot](../assets/wiki/virtuality-dactyl-3.jpg)
*Screenshot of *Dactyl Nightmare* running on original 1000CS hardware. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Virtuality_(product))*

### Sources

1. Wikipedia, “Virtuality (product)” — https://en.wikipedia.org/wiki/Virtuality_(product)
2. Virtual Reality Society, “Virtuality – A New Reality of Promise, Two Decades Too Soon” — https://www.vrs.org.uk/dr-jonathan-walden-virtuality-new-reality-promise-two-decades-soon/
3. Heise Online, “Virtual reality in the 90s: how the first VR hype started in arcades” — https://www.heise.de/en/background/Virtual-reality-in-the-90s-how-the-first-VR-hype-started-in-arcades-10478602.html
4. Time Extension, “Virtuality, The 1990s Pioneer That Sold The World On VR” — https://www.timeextension.com/features/the-making-of-virtuality-the-1990s-pioneer-that-sold-the-world-on-vr
5. V-Rtifacts, “Virtuality History” (archived) — https://web.archive.org/web/20221111015229/https://vrtifacts.com/wp-content/uploads/2010/07/vhist.html
6. YouTube, “VIRTUALITY DACTYL NIGHTMARE REVIEW! Experience VR From 1990 Right Now!” — https://www.youtube.com/watch?v=mAcGA5XdZHY
7. YouTube, “Playing Dactyl Nightmare on Real 1990s VR Hardware!” — https://www.youtube.com/watch?v=Nz_BeaBS_cg

---
## Steve Mann’s EyeTap / Wearable Computing (1980s)

**By:** Steve Mann  
**Tags:** `Wearable Computing` `Augmented Reality` `Mediated Reality` `Sousveillance` `Input`
...
![Injection-molded EyeTap](../assets/wiki/eyetap-aimoneyetap-1.jpg)
*Man wearing an injection-molded one-eyed EyeTap. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/EyeTap)*

![Laser EyeTap](../assets/wiki/eyetap-mann-glass-2.jpg)
*Steve Mann wearing a metal-frame Laser EyeTap. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Steve_Mann_(inventor))*

![Generation-4 EyeTap](../assets/wiki/eyetap-gen4-3.jpg)
*Steve Mann with a Generation-4 EyeTap Digital Eye Glass, 1999. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Steve_Mann_(inventor))*

### Sources

1. Wikipedia, “EyeTap” — https://en.wikipedia.org/wiki/EyeTap
2. Wikipedia, “Steve Mann (inventor)” — https://en.wikipedia.org/wiki/Steve_Mann_(inventor)
3. IEEE Spectrum, “The Accidental Engineer Who Conjured Up Extended Reality” — https://spectrum.ieee.org/engineer-conjured-up-extended-reality
4. Steve Mann, “Wearable Computing: Toward Humanistic Intelligence” (IEEE Intelligent Systems, 2001) — https://ieeexplore.ieee.org/document/940020
5. YouTube, “DEF CON 7 - Steve Mann: The Inventor of the So Called Wearable Computer” — https://www.youtube.com/watch?v=HVquUd-MFtU
6. YouTube, “The Father of Wearable Computing | Steve Mann | TEDxUTSC” — https://www.youtube.com/watch?v=Z9qiWqRPrcw

---
## Mandala / The Vivid Group Gesture VR System (1986)

**By:** The Vivid Group (Vincent John Vincent & Francis MacDougall)  
**Tags:** `Gesture` `VR` `Computer Vision` `Interactive Art` `Amiga` `Accessibility`
...
Because the output was displayed on ordinary monitors, projectors, or video walls, Mandala installations could support multiple simultaneous participants and spectators. Notable deployments included the Tech2000 Gallery of Interactive Education in Washington, D.C., the CN Tower in Toronto, the Bell Canada Video Teleconferencing Forum, and later the *Nick Arcade* and *Total Panic* TV shows on Nickelodeon. *Popular Science* named Mandala one of the top breakthrough technologies of 1990. The technology evolved into GestureXtreme and eventually into GestureTek, whose patents later influenced Sony EyeToy and Microsoft Kinect.

* **Weird / fun facts.** The name “Mandala” was chosen from Sanskrit to evoke a person at the center of an interconnected, multidimensional universe whose creative input becomes part of a cosmic dance. Vincent John Vincent used the system to become what the company calls the world’s first “Virtual Reality Performer / Virtual Musician.”
...
![Mandala at SIGGRAPH 1991](../assets/wiki/mandala-siggraph-1.jpg)
*SIGGRAPH 1991 Immersive Pavilion exhibit photo of The Mandala VR System by The Vivid Group. Source: [ACM SIGGRAPH History Archives](https://history.siggraph.org/experience/the-mandala-vr-system-by-wyshynski/)*

![Mandala demo thumbnail](../assets/wiki/mandala-video-thumb-2.jpg)
*YouTube thumbnail for “Mandala (Amiga, 1986) – The First Motion Sensing VR System.” Source: [YouTube](https://www.youtube.com/watch?v=h6xHpyJQ6GQ)*

### Sources

1. ACM SIGGRAPH History Archives, “‘The Mandala VR System’ by Wyshynski” — https://history.siggraph.org/experience/the-mandala-vr-system-by-wyshynski/
2. GestureTek Health, “Timeline” — https://gesturetekhealth.com/timeline
3. GestureTek Health, “History” — https://gesturetekhealth.com/about/history
4. YouTube, “Mandala (Amiga, 1986) – The First Motion Sensing VR System” — https://www.youtube.com/watch?v=h6xHpyJQ6GQ
5. YouTube, “Amiga Mandala Powering Museum, Music, Games, and More – Vivid Group Videos Compilation” — https://www.youtube.com/watch?v=RwAXPY6jwCE

---
## Handykey Twiddler Chord Keyboard (1992)

**By:** HandyKey Corporation / Tek Gear  
**Tags:** `Input` `Chorded Keyboard` `One-Handed` `Mobile` `Wearable`
...
The original Twiddler communicated over a serial port and drew power from a PC/AT keyboard port. Later revisions added USB (Twiddler 2.1), Bluetooth, and haptic feedback (Twiddler 3). The Twiddler became a fixture in the MIT Wearable Computing Group and related wearable-computing research: Thad Starner and other early wearable pioneers used it for one-handed text entry while walking. A CHI 2004 Georgia Tech study found that an experienced Twiddler user could average roughly 60 words per minute with letter-by-letter typing of standard phrases.

HandyKey was acquired by Canadian firm Tek Gear in 2007. In 2024 the Twiddler 4 was announced with USB-C or Bluetooth connectivity and an optical trackpad replacing the earlier joystick.

* **Weird / fun facts.** The Twiddler packs keyboard, mouse, and (in later models) motion control into a device small enough to hold in one hand. It is a rare example of a 1990s input device still in active development more than 30 years later.
...
![Original Twiddler (1992)](../assets/wiki/twiddler-original-1.png)
*The original Twiddler model from 1992. Source: [Wikimedia Commons](https://en.wikipedia.org/wiki/Twiddler)*

![Twiddler in use](../assets/wiki/twiddler-lgr-thumb-2.jpg)
*YouTube thumbnail for LGR’s “Twiddler Motion Controlled Keyboard Mouse from 1992.” Source: [YouTube](https://www.youtube.com/watch?v=HhJGrATZCl0)*

### Sources

1. Wikipedia, “Twiddler” — https://en.wikipedia.org/wiki/Twiddler
2. New Atlas, “Learning the one-handed Twiddler3 keyboard a challenge worth taking” — https://newatlas.com/one-handed-twiddler3-keyboard-tekgear/36952/
3. The Register, “Come and Twiddle Tek Gear's one handed keyboard” — https://www.theregister.com/2015/01/21/review_tek_gear_twiddler_3_remote_handheld_keyboard/
4. Lyngbäck et al. / Georgia Tech, “Twiddler Typing: One-Handed Chording Text Entry for Mobile Phones” (CHI 2004) — https://sites.cc.gatech.edu/home/thad/p/030_10_MTE/twiddler-chi04.pdf
5. YouTube, “LGR Oddware: Twiddler Motion Controlled Keyboard Mouse from 1992” — https://www.youtube.com/watch?v=HhJGrATZCl0
6. YouTube, “Twiddlering!” — https://www.youtube.com/watch?v=zZhWa2FfEac

---
## Appendix: Image Credits

| Component | File | Caption | Source |
|---|---|---|---|
| Hubot | `hubot-cnet.webp` | CNET gallery photo | [CNET](https://www.cnet.com/pictures/rise-of-the-robots-from-sci-fi-to-our-homes/) |
| Hubot | `hubot-hardware.webp` | Hardware.com.br detail | [Hardware.com.br](https://www.hardware.com.br/tecnologia/hubot-robo-atari-1984/) |
| Hubot | `hubot-sciencephoto.jpg` | Science Photo Library | [Science Photo Gallery](https://sciencephotogallery.com/featured/hubot-robot-volker-steger.html?product=acrylic-print) |
| P300 Speller | `p300-rowcolumn.webp` | Row-column paradigm | [Frontiers](https://www.frontiersin.org/journals/human-neuroscience/articles/10.3389/fnhum.2022.1077717/full) |
| P300 Speller | `p300-paper-01.png` | First page of 1988 paper | [Farwell PDF](https://www.farwellbrainfingerprinting.com/pdf/Farwell-Donchin-1988-Talking-Off-the-Top-of-Your-Head-BCI-brain-computer-interface.pdf) |
| VPL | `vpl-datasuit.jpg` | VPL DataSuit | [Wikimedia Commons](https://en.wikipedia.org/wiki/VPL_Research) |
| VPL | `vpl-eyephone-demo.jpg` | EyePhone/DataGlove demo | [Flashbak](https://flashbak.com/jaron-laniers-eyephone-head-and-glove-virtual-reality-in-the-1980s-26180/) |
| VPL | `vpl-jaron-lanier.jpg` | Jaron Lanier | [Flashbak](https://flashbak.com/jaron-laniers-eyephone-head-and-glove-virtual-reality-in-the-1980s-26180/) |
| Put-That-There | `put-that-there-paper-1.png` | SIGGRAPH ’80 title page | [MIT Media Lab](https://dam-prod.media.mit.edu/uuid/8e6d934b-6c6f-48e4-b0a1-270e0dae745f) |
| Put-That-There | `put-that-there-video.jpg` | Demo thumbnail | [YouTube](https://www.youtube.com/watch?v=RyBEUyEtxQo) |
| VIDEOPLACE | `videoplace-mediaartnet.jpg` | Videoplace still | [Media Art Net](http://www.medienkunstnetz.de/works/videoplace/) |
| VIDEOPLACE | `videoplace-video.jpg` | 1989 demo thumbnail | [YouTube](https://www.youtube.com/watch?v=dqZyZrN3Pl0) |
| Power Glove | `power-glove-1.jpg` | NES Power Glove | [Wikimedia Commons](https://en.wikipedia.org/wiki/Power_Glove) |
| Power Glove | `power-glove-2.jpg` | Promotional art | [ACMI](https://www.acmi.net.au/stories-and-ideas/nintendo-nes-power-glove/) |
| Active Badge | `active-badge-1.gif` | Four badge generations | [Cambridge/AT&T archive](https://www.cl.cam.ac.uk/research/dtg/attarchive/ab.html) |
| Digital Desk | `digital-desk-1.gif` | Prototype projection | [NAVER LABS Europe](https://europe.naverlabs.com/history/past-research/digitaldesk-to-camworks/) |
| Digital Desk | `digital-desk-2.jpg` | CHI ’92 video thumbnail | [YouTube](https://www.youtube.com/watch?v=laApNiNpnvI) |
| Atari Mindlink | `atari-mindlink-1.jpg` | National Videogame Museum | [Wikimedia Commons](https://en.wikipedia.org/wiki/Atari_Mindlink) |
| Atari Mindlink | `atari-mindlink-2.jpg` | Atari Museum prototype | [Atari Museum](https://atarimuseum.ctrl-alt-rees.com/videogames/consoles/2600/mindlink.html) |
| Speak & Spell | `speak-spell-1.jpg` | 1978 American model | [Wikimedia Commons](https://en.wikipedia.org/wiki/Speak_%26_Spell_(toy)) |
| Speak & Spell | `speak-spell-2.jpg` | CHM timeline | [Computer History Museum](https://www.computerhistory.org/timeline/ai-robotics/) |
| Kurzweil Reading Machine | `kurzweil-reading-machine-1.jpg` | Promotional photo | [Kurzweil Technologies](http://www.kurzweiltech.com/kcp.html) |
| Virtuality | `virtuality-1000cs-1.jpg` | 1000CS stand-up pod | [Wikimedia Commons](https://en.wikipedia.org/wiki/Virtuality_(product)) |
| Virtuality | `virtuality-1000sd-2.jpg` | 1000SD sit-down unit | [Wikimedia Commons](https://en.wikipedia.org/wiki/Virtuality_(product)) |
| Virtuality | `virtuality-dactyl-3.jpg` | Dactyl Nightmare | [Wikimedia Commons](https://en.wikipedia.org/wiki/Virtuality_(product)) |
| EyeTap | `eyetap-aimoneyetap-1.jpg` | Injection-molded EyeTap | [Wikimedia Commons](https://en.wikipedia.org/wiki/EyeTap) |
| EyeTap | `eyetap-mann-glass-2.jpg` | Laser EyeTap | [Wikimedia Commons](https://en.wikipedia.org/wiki/Steve_Mann_(inventor)) |
| EyeTap | `eyetap-gen4-3.jpg` | Generation-4 EyeTap | [Wikimedia Commons](https://en.wikipedia.org/wiki/Steve_Mann_(inventor)) |
| Mandala | `mandala-siggraph-1.jpg` | SIGGRAPH 1991 exhibit | [ACM SIGGRAPH History](https://history.siggraph.org/experience/the-mandala-vr-system-by-wyshynski/) |
...
## Minsky Sandpaper / Computational Haptics Sandpaper System (1990)

**By:** Margaret Minsky at MIT Media Lab, with collaborators at UNC Chapel Hill (Frederick P. Brooks Jr., Ming Ouh-young, Oliver Steele, Michael Behensky)  
**Tags:** `HCI` `Haptics` `Force Feedback` `Texture Synthesis` `MIT Media Lab` `VR`
...
![Margaret Minsky with the force-feedback joystick, photographed by Peter Menzel](../assets/wiki/minsky-sandpaper-1.webp)
*Margaret Minsky with the Sandpaper force-feedback joystick. The wooden box houses DC servo motors, optical encoders, and direct-drive linkages that rendered virtual textures through lateral forces. Photo by Peter Menzel. (mminsky.com)*

![Close-up of haptic hardware — motors, linkages, and the wooden box enclosure](../assets/wiki/minsky-sandpaper-2.webp)
*Inside the Sandpaper joystick: Pittman-series DC servo motors mounted at right angles with direct-drive linkages and optical encoders for precise position sensing. (mminsky.com)*

![Force-Feedback Joystick as preserved in the King's College London research collection](../assets/wiki/minsky-sandpaper-3.jpg)
*The force-feedback joystick preserved in the Margaret Minsky research collection at King's College London — one of the surviving artifacts of computational haptics' origin moment. (King's College London)*

![Margaret Minsky with the joystick, archival print of the Peter Menzel photograph](../assets/wiki/minsky-sandpaper-4.jpg)
*Archival print of Peter Menzel's photograph of Margaret Minsky with the Sandpaper joystick, from the King's College London research collection. (King's College London)*

### Sources

1. Minsky, M. (1995). Computational haptics: the Sandpaper system for synthesizing texture for a force-feedback display. PhD Thesis, MIT. Advisor: Nicholas Negroponte. — https://dspace.mit.edu/handle/1721.1/29094
2. Minsky, M., Ouh-young, M., Steele, O., Brooks, F. P., & Behensky, M. (1990). Feeling and Seeing: Issues in Force Display. ACM SIGGRAPH Computer Graphics, 24(2), 235–241. (880+ citations) — https://doi.org/10.1145/91394.91451
3. Minsky, M. & Lederman, S. J. (1996). Simulated Haptic Textures: Roughness. ASME IMECE, DSC-Vol. 58. — https://doi.org/10.1115/imece1996-0365
4. Margaret Minsky — Research Page (mminsky.com) — https://mminsky.com/research.html
5. Margaret Minsky — King's College London Research Collection — https://www.kcl.ac.uk/research/margaret-minsky
6. Margaret Minsky — Exploratorium Tinkering Studio — https://www.exploratorium.edu/tinkering/tinkerers/margaret-minsky
7. Margaret R. Minsky — ACM SIGGRAPH History Archives — https://history.siggraph.org/person/margaret-r-minsky/
8. Margaret Minsky — HKUST(GZ) Computational Media and Arts faculty profile — http://cma.hkust-gz.edu.cn/faculty-regular/margaret-minsky/
9. Marvin Minsky obituary — MIT News (confirms Margaret Minsky as daughter) — https://news.mit.edu/2016/marvin-minsky-obituary-0125

---

## Quantel Paintbox (1981)

**By:** Quantel Ltd. (Peter Michael, Richard Taylor, Paul Kellar, Martin Holbrook)  
**Tags:** `Graphics HCI` `Pressure-Sensitive Stylus` `Broadcast Graphics` `Digital Painting` `Workstation` `Tablet`
...
![Quantel Paintbox 7001 workstation with Paintbox V logo](../assets/wiki/quantel-paintbox-1.jpg)
*The Quantel Paintbox 7001 series workstation, showing the Paintbox V logo from the 1990 second-generation model. (Wikimedia Commons, CC BY-SA)*

![Interior view of a Quantel Paintbox showing the rack of custom circuit boards](../assets/wiki/quantel-paintbox-2.jpg)
*Inside the Quantel Paintbox: hundreds of custom ICs and PALs implemented all painting functions in dedicated hardware — a room-sized accelerated graphics card. (Wikimedia Commons, CC BY-SA)*

![Quantel Paintbox monitor viewing screen menus and large drawing tablet with stylus](../assets/wiki/quantel-paintbox-3.jpg)
*The Paintbox's pressure-sensitive stylus and drawing tablet, with pop-up menus displayed on the CRT monitor — the interface that defined broadcast graphics production for over a decade. (Wikimedia Commons, CC BY-SA)*

![Vintage Quantel Paintbox showing on-screen graphical menus and drawing tools](../assets/wiki/quantel-paintbox-4.jpg)
*The Quantel Paintbox graphical interface, showing the pop-up menu system and drawing tools — remarkably consistent across the product's entire 15-year lifespan. (Wikimedia Commons)*

### Sources

1. Quantel Paintbox - Wikipedia — https://en.wikipedia.org/wiki/Quantel_Paintbox
2. How Quantel's Paintbox Revolutionized TV Graphics 40 Years Ago — TV Technology (Adrian Wilson, 2021) — https://www.tvtechnology.com/opinion/how-quantels-paintbox-revolutionized-tv-graphics-40-years-ago
3. Quantel Paintbox History: The Stylus That Revolutionized Television — Tedium (David Buck, 2022) — https://tedium.co/2022/03/25/quantel-paintbox-history/
4. The Quantel Paintbox — a pioneering computer graphics workstation (Bob Pank, Quantel blog, 2011, archived) — https://web.archive.org/web/20121108191518/http://blog.quantel.eu/2011/03/the-quantel-paintbox-a-pioneering-computer-graphics-workstation/
5. Quantel - Wikipedia (company history, founders, product timeline) — https://en.wikipedia.org/wiki/Quantel
6. Peter Michael (engineer) - Wikipedia — https://en.wikipedia.org/wiki/Peter_Michael_(engineer)
7. Quantel Digital Paintbox 7001 — Powerhouse Museum Collection (Sydney) — https://collection.powerhouse.com.au/object/607626
8. The Big Box of Magic: A Love Letter to the Quantel Paintbox — UX Planet (Mat Venn, 2022) — https://uxplanet.org/the-big-box-of-magic-ebc1fc6c5cc4
9. Quantel Paintbox — Computer Arts Society Exhibition Catalogue (2023) — https://www.computer-arts-society.com/exhibitions/CAS-Quantel-Paintbox-Catalogue.pdf
10. Paintbox: Art x Engineering — Google Arts & Culture / Museum of Engineering Innovation — https://artsandculture.google.com/story/paintbox-art-x-engineering-museum-of-engineering-innovation/QwXxUjPEZ8tMEQ

---

## Tongue Touch Keypad (TTK) / Tongue Activated Communications Controller (1991)

**By:** Zofcom Inc. / Zofcom Systems Inc. (Palo Alto, CA), later New Abilities Systems Inc. Principal Investigator: Daniel Fortune.  
**Tags:** `HCI` `Accessibility` `Assistive Technology` `Tongue Interface` `Intraoral` `Wearable` `Quadriplegia` `Environmental Control` `Dental Appliance`
...
![Intraoral appliances with built-in electronics: (a) Tongue-Touch Keypad, the dental retainer with nine-key membrane keypad and embedded electronics](../assets/wiki/tongue-touch-keypad-1.png)
*The Tongue Touch Keypad (TTK) intraoral appliance with nine-key membrane keypad and embedded transmitter. From Huo & Ghovanloo (2014), Sensors 14(11):21565, referencing the original Zofcom/New Abilities design.*

![US Patent 5,523,745 Figure 1: block diagram of the tongue activated communications controller system](../assets/wiki/tongue-touch-keypad-2.png)
*US Patent 5,523,745 (Zofcom Systems Inc., filed 1991) Figure 1: System block diagram showing the intraoral tongue keypad, encoder, transmitter, external receiver, and controller connected to controlled devices. Source: Google Patents/USPTO.*

### Sources

1. SBIR.gov — 'ADAPTATION OF TONGUE TOUCH KEYPAD AND SMARTLINK SYSTEM TO EDUCATIONAL APPLICATIONS' (Zofcom Inc., 1990, DoEd Phase I, $29,520). Full abstract with technical description of the nine-key membrane keypad, digital encoder, radio transmitter, and Smartlink Controller. — https://www.sbir.gov/awards/125752
2. SBIR.gov — Zofcom Inc. Company Portfolio. Shows Phase I award in 1984 and Phase II award in 1987 for 'Tongue Activated Computer Control for the Handicapped.' — https://www.sbir.gov/portfolio/354566
3. FDA 510(k) K911101 — 'TONGUETOUCH KEYPAD AND ZOFCOM CONTROL SYSTEM' (Zofcom Inc., cleared April 25, 1991). Class II powered environmental control system. — https://fda.report/PMN/K911101
4. FDA 510(k) K932786 — 'UCS 1000(TM) WITH TONGUETOUCH KEYPAD WHEELCHAIR' (New Abilities Systems Inc., cleared March 28, 1994). — https://fda.innolitics.com/submissions/PM/subpart-d—physical-medicine-prosthetic-devices/ITI/K932786
5. US Patent 5,523,745 — 'Tongue activated communications controller' (Zofcom Systems Inc., filed 1991, issued 1996). Detailed technical description of the intraoral keypad, magnetic flux coupling transmitter, and multi-device controller. — https://www.freepatentsonline.com/5523745.html
6. US Patent 4,783,656 — 'Intra-oral control unit and system' (Thomas Jefferson University, filed 1986, issued 1988). Precursor: single-switch intraoral FM transmitter on a dental appliance for environmental control. — https://www.freepatentsonline.com/4783656.html
7. Mountain Shadows Support Group — 'Tongue-Touch Keypad Gives Voice to Resident' (Constant Contact). Stacy Bibb's story: 25+ years with the TTK, starting in 1991 at age 17. — https://myemail.constantcontact.com/Tongue-Touch-Keypad-Gives-Voice-to-Resident.html
8. Mountain Shadows Support Group — 'Come Closer and Touch His Cheek' (2023). Details about the TTK as a dental retainer device; the company's bankruptcy; Stacy's three years without the device. — https://mtnshadows.org/2023/06/come-closer-and-touch-his-cheek/
9. NBC News / Associated Press — 'Turning the tongue into a computer control pad' (Aug 24, 2008). Describes Georgia Tech Tongue Drive System and explicitly references newAbilities Systems Inc.'s nine-button keypad as predecessor. — https://www.nbcnews.com/id/wbna26338543
10. Huo & Ghovanloo (2014) — 'An Arch-Shaped Intraoral Tongue Drive System with Built-in Tongue-Computer Interfacing SoC,' Sensors 14(11):21565. Includes photograph of the original TTK dental retainer alongside newer tongue-drive devices. — https://www.mdpi.com/1424-8220/14/11/21565

---

## Aesthedes (1984)

**By:** Claessens Product Consultants / Aesthedes NV, founded by Dominique P.G. Claessens in Hilversum, Netherlands  
**Tags:** `CAD` `Workstation` `Design` `Keyboard` `Vector Graphics` `Dutch` `Prepress`
...
![Aesthedes 2 console with six screens and membrane keyboard desk](../assets/wiki/aesthedes-1.jpg)
*Aesthedes 2 console showing the three colour monitors, three data screens, and 636-key membrane desk. (Wikimedia Commons)*

![Fully restored Aesthedes 2 at HomeComputerMuseum Netherlands](../assets/wiki/aesthedes-2.jpg)
*Fully restored Aesthedes 2 at the HomeComputerMuseum, Helmond. (Wikimedia Commons)*

![Two working Aesthedes computers side by side at HomeComputerMuseum](../assets/wiki/aesthedes-3.jpg)
*Two working Aesthedes computers — the only pair known to be operational anywhere. (Wikimedia Commons)*

![Aesthedes 1 in use at Computer Aided Visuals, Amsterdam, 1988](../assets/wiki/aesthedes-4.jpg)
*Aesthedes 1 in use at Computer Aided Visuals, Amsterdam, 1988. (Wikimedia Commons)*

### Sources

1. Wikipedia: Aesthedes — https://en.wikipedia.org/wiki/Aesthedes
2. Dutch Wikipedia: Aesthedes (extensive technical and UI detail) — https://nl.wikipedia.org/wiki/Aesthedes
3. AIS/Design: 'Total Design and the Case of the Aesthedes Computer' (Karin van der Heiden, 2016) — https://web.archive.org/web/20170306103027/http://www.aisdesign.org/aisd/en/total-design-sistema-aesthedes-cambiare-gli-strumenti-del-graphic-design-olanda-negli-anni-ottanta
4. Shift Happens: 'The Modifiers vs. The Keepers' (Marcin Wichary, 2022) — https://newsletter.shifthappens.site/archive/the-modifiers-vs-the-keepers/
5. HomeComputerMuseum: Aesthedes collection page — https://www.homecomputermuseum.nl/en/collectie/aesthedes/aestedes/
6. HomeComputerMuseum Labs: Project Aesthedes restoration timeline — https://labs.homecomputer.museum/uncategorized/project-aesthedes/
7. GoFundMe: Rescue and Restore the Aesthedes 1 (March 2024) — https://www.gofundme.com/f/rescue-and-restore-the-aesthedes-1
8. UvA Computer Museum: Aesthedes page — https://ub.fnwi.uva.nl/computermuseum/aesthedes.html
9. De Nieuwe Schatkamer: The 25-Guilder Robin Banknote — https://www.denieuweschatkamer.nl/en/money-collection/extraordinary-money-extraordinary-stories/the-25-guilder-robin-banknote
10. KBD.news: Aesthedes 2 keyboard analysis — https://kbd.news/Aesthedes-2-1096.html
11. SIGGRAPH History: Aesthedes Inc. exhibitor profile — https://history.siggraph.org/exhibitor/aesthedes-inc/
12. Bitsavers: Aesthedes archive (manuals, software) — http://bitsavers.informatik.uni-stuttgart.de/pdf/aesthedes/
13. New Scientist: 'Computer Graphics Challenges Artists' (Sept 5, 1985) — https://books.google.com/books?id=6uYQcwmQO3QC&pg=PA35
14. YouTube: Aesthedes Promotional Video — https://www.youtube.com/watch?v=vO0a8veCOek

---

## RDI Halcyon (1985)

**By:** RDI Video Systems (Rick Dyer, founder), Carlsbad, California  
**Tags:** `Gaming` `Voice Recognition` `Laserdisc` `Speech Synthesis` `Interactive Movie` `CES`
...
![RDI Halcyon console, keyboard, and headset](../assets/wiki/rdi-halcyon-1.jpg)
*The RDI Halcyon system: computer unit, membrane keyboard, and voice headset. Photo from handheldmuseum.com collection.*

![RDI Halcyon promotional flyer](../assets/wiki/rdi-halcyon-2.jpg)
*RDI Halcyon promotional flyer showing the console, headset, and Thayer's Quest game. (Handheld Museum)*

### Sources

1. Wikipedia: Halcyon (console) — https://en.wikipedia.org/wiki/Halcyon_(console)
2. Polygon: 'The Story of the Halcyon, the Most Rare Console in History' (2018) — https://www.polygon.com/videos/2018/3/1/17063348/halcyon-rare-console-history
3. AtariHQ: RDI Halcyon detailed history and photos — https://atarihq.com/mainsite/rdi-halcyon/
4. Giant Bomb: Halcyon wiki entry — https://www.giantbomb.com/rdi-halcyon/3045-116/
5. The Dragon's Lair Project: Halcyon history — https://www.dragons-lair-project.com/community/related/halcyon/
6. Old-Computers.com: RDI Halcyon — https://www.old-computers.com/museum/computer.asp?c=954
7. RDI Halcyon promotional brochure scans — https://atarihq.com/mainsite/rdi-halcyon/
8. Video Game Console Library: Halcyon — https://www.videogameconsolelibrary.com/pg80-halcyon.htm
9. YouTube: Rare Halcyon Console Footage at CES 1985 — https://www.youtube.com/results?search_query=RDI+Halcyon+CES+1985

---

## Talking Signs / Remote Infrared Audible Signage (RIAS) (1979)

**By:** Smith-Kettlewell Eye Research Institute (SKERI), San Francisco. Invented by William (Bill) Loughborough.  
**Tags:** `Accessibility` `Infrared` `Navigation` `Ambient Interface` `Environmental HCI` `Assistive Technology` `Wayfinding`
...
![Talking Signs handheld receiver and wall-mounted transmitter](../assets/wiki/talking-signs-1.jpg)
*Talking Signs receiver (left) and wall-mounted infrared transmitter (right). (Smith-Kettlewell Eye Research Institute)*

### Sources

1. Wikipedia: Remote Infrared Audible Signage — https://en.wikipedia.org/wiki/Remote_infrared_audible_signage
2. SKTF Fall 1991 (complete issue): Talking Signs schematics, parts list, deployment guide — https://www.ski.org/sktf-fall-1991/
3. SKERI: Talking Signs project page (40-year history) — https://www.ski.org/project/talking-signs/
4. Crandall, Bentzen, Myers, Steed (1995): 'Talking Signs Remote Infrared Signage: A Guide for Transit Managers' (FTA Project ACTION) — https://ntlrepository.blob.core.windows.net/docs/95-0051-7.html
5. Crandall et al. (1999): 'Remote Infrared Signage Evaluation for Transit Stations and Intersections,' JRRD 36(4) — http://www.rehab.research.va.gov/jour/99/36/4/crandall.pdf
6. Crandall (1998): 'Talking Signs Remote Infrared Audible Signage,' CSUN 1998 Conference — https://www.dinf.ne.jp/doc/english/Us_Eu/conf/csun_98/csun98_063.html
7. Loughborough (1979): 'Talking Lights,' JVIB 73(6) — https://www.ski.org/publication/talking-lights/
8. Brabyn & Brabyn (1983): 'An Evaluation of Talking Signs for the Blind,' Human Factors 25(1) — https://pubmed.ncbi.nlm.nih.gov/6840772/
9. Marston & Golledge: UCSB RIAS research overview — https://people.geog.ucsb.edu/~marstonj/DIS/OVERVIEW.html
...
**By:** Bally Manufacturing Corporation / Life Fitness, Inc.  
**Tags:** `Exergaming` `Fitness` `Rowing` `Game Console` `Physical Controller`
...
![LifeRower rowing machine with built-in CRT monitor displaying the Pacer boat racing game](../assets/wiki/liferower-1.png)
*LifeRower rowing machine (1986) with built-in CRT monitor and Pacer boat racing game showing the scrolling waterway, buoys, on-screen rower, and dashboard. Source: National Videogame Museum, UK (CC BY-NC).*

![Close-up of the LifeRower CRT display showing the boat racing game with HUD dashboard](../assets/wiki/liferower-2.png)
*Close-up of the LifeRower's CRT display showing the Pacer racing mode with on-screen dashboard (stroke rate, calories, distance, boat lengths ahead/behind), parallax shoreline, and cityscape background. Source: National Videogame Museum, UK (CC BY-NC).*

### Sources

1. US Patent 4,674,741 — "Rowing machine with video display" (Bally Manufacturing Corp., filed Aug 1985, issued Jun 1987) — https://patents.google.com/patent/US4674741A/
2. National Videogame Museum (UK) — LifeRower object record (SHEVG.2024.11) — https://thenvm.org/objects/liferower-rowing-machine/
3. Life Fitness corporate history — 1980s timeline (archived) — https://web.archive.org/web/20181230221726/http://lifefitness.com/facility/about/our-story/1980s
4. Undumped Wiki — LifeRower technical documentation, screenshots, and revision history — https://undumped.miraheze.org/wiki/LifeRower
...
## Kay Visi-Pitch / Electroglottograph (1987)

**By:** Kay Elemetrics Corporation (Lincoln Park, New Jersey)  
**Tags:** `HCI` `Biosignal Input` `Medical/Clinical` `Biofeedback` `Speech` `Wearable`
...
*A Glottal Enterprises EG2-PCX electroglottograph — a competing device to Kay Elemetrics' EGG, but representative of the era's EGG hardware. Both Kay and Glottal units used similar gold-plated neck electrodes and impedance measurement principles. Photo via Wikimedia Commons (CC-licensed).*

![Oscilloscope trace comparing EGG signals from Glottal Enterprises (top) and Laryngograph/Kay electroglottograph (bottom)](../assets/wiki/egg-signal-comparison.jpg)
*EGG signal comparison: Glottal Enterprises EG2-PC (top trace) and Laryngograph/Kay electroglottograph (bottom trace). The Kay/Laryngograph signal shows the characteristic Lx waveform representing vocal fold contact area over time. Via Wikipedia.*

### Sources

1. Wikipedia: Electroglottograph — https://en.wikipedia.org/wiki/Electroglottograph
2. Baken, R.J. (1987). Clinical Measurement of Speech and Voice. College Hill Press — foundational textbook comparing early commercial EGG units including Kay Elemetrics — https://books.google.com/books?id=9Y9qAAAAMAAJ
3. Orlikoff, R.F. (1991). 'Assessment of the dynamics of vocal fold contact from the electroglottogram: The Kay Elemetrics Visi-Pitch Model 6094.' Journal of Speech and Hearing Research, 34(4), 689-696 — https://pubmed.ncbi.nlm.nih.gov/1956185/
4. Rothenberg, M. (1992). 'A Multichannel Electroglottograph.' Journal of Voice, Vol. 6, No. 1, pp. 36-43 — http://www.rothenberg.org/Multichannel/Multichannelpdf.pdf
5. Rothenberg, M. & Mahshie, J.J. (1988). 'Monitoring vocal fold abduction through vocal fold contact area.' Journal of Speech and Hearing Research, 31(3), 338-351 — http://www.rothenberg.org/Monitoring/Monitoring.pdf
...
**By:** Entex Industries, Inc. (Compton, California)  
**Tags:** `HCI` `Display` `Mechanical Scan` `Rotating Mirror` `Handheld` `LED` `Commercial Failure`
...
![Entex Adventure Vision handheld game console — front view showing the binocular-style viewport, joystick, and 4 buttons arranged symmetrically](../assets/wiki/adventure-vision-1.jpg)
*The Entex Adventure Vision console — front view showing the mirror viewport, central joystick, and 4 buttons arranged symmetrically (2 left, 2 right) for left/right-handed play. CC BY-SA 4.0 photo by Rik1138 (2013), via Wikimedia Commons.*

![Entex Adventure Vision with background removed — clean profile showing the bulk of the housing](../assets/wiki/adventure-vision-2.jpg)
*The Adventure Vision with background removed, showing the bulky 13.25 × 10 × 9 inch housing required for the motor, mirror, and LED column. CC BY-SA 4.0 derivative by Céréales Killer (2017), via Wikimedia Commons.*

### Sources

1. Wikipedia: Entex Adventure Vision — https://en.wikipedia.org/wiki/Entex_Adventure_Vision
2. Wikipedia: Entex Industries — https://en.wikipedia.org/wiki/Entex_Industries
3. Wikimedia Commons: Category:Entex Adventure Vision (2 CC BY-SA 4.0 files by Rik1138) — https://commons.wikimedia.org/wiki/Category:Entex_Adventure_Vision
4. Handheld Museum: Adventure Vision (collector source, includes McCaslin credits and mirror photo) — https://www.handheldmuseum.com/Entex/AV.html
5. AdventureVision.com (fan site; Bob McCaslin's prototype gallery) — http://www.adventurevision.com/
6. AdventureVision.com prototype gallery (McCaslin's personal dev photos) — http://www.adventurevision.com/AV-prototype.html
7. Destructoid: 'Bit Museum #4 — What the Hell is an Entex Adventure Vision?' (~100 surviving units) — https://www.destructoid.com/bit-museum-4-what-the-hell-is-an-entex-adventure-vision/
8. Internet Archive: Adventure Vision library (in-browser playable emulator) — https://archive.org/details/adventurevision_library
9. Forster, Winnie (2005). The encyclopedia of consoles, handhelds & home computers 1972–2005. GAMEPLAN. p. 53. ISBN 3-00-015359-4. — https://en.wikipedia.org/wiki/Entex_Adventure_Vision

---

## BBC Domesday Project (1986)

**By:** BBC (Peter Armstrong, Andy Finney) with Acorn Computers, Philips, and Logica; 1M+ crowd contributors  
**Tags:** `HCI` `Laserdisc` `Interactive Video` `Trackball` `GUI` `Reference System` `Crowdsourcing` `Digital Obsolescence` `Genlock`
...
![Complete BBC Domesday system: Acorn Master AIV computer, Philips VP415 laserdisc player, and Marconi RB2 trackerball on a desk](../assets/wiki/bbc-domesday-system.jpg)
*The complete BBC Domesday hardware stack: Acorn Master AIV computer (left, with function-key overlay strip on the keyboard), Philips VP415 'Domesday Player' laserdisc player (right), and Marconi RB2 trackerball. CC BY 2.0 photo by Simon Inns, via Wikimedia Commons.*

![BBC Domesday machine keyboard showing the printed function-key overlay strip with navigation labels — Walk, Find, Photo, Data, Video, Index](../assets/wiki/bbc-domesday-keyboard.jpg)
*BBC Master keyboard with the printed function-key overlay strip carrying the 16 labelled navigation keys (Walk, Find, Photo, Data, Video, Index, etc.) — the GUI's primary command surface, paired with the trackball. CC BY 2.0 photo by Paul Downey, via Wikimedia Commons.*

### Sources

1. Andy Finney (project co-founder), primary-source website: 'The BBC Domesday Project — November 1986' — https://www.atsf.co.uk/dottext/domesday.html
2. Wikipedia: BBC Domesday Project — https://en.wikipedia.org/wiki/BBC_Domesday_Project
3. Wikipedia: LV-ROM (hardware/format details, SCSI-1 claim) — https://en.wikipedia.org/wiki/LV-ROM
4. Wikipedia: BBC Domesday Reloaded (2011–18 recovery) — https://en.wikipedia.org/wiki/BBC_Domesday_Reloaded
5. Domesday86 project (modern open-hardware preservation; Domesday Duplicator) — https://www.domesday86.com/
6. Philips VP415 Operating Instructions (PDF, 1986) — https://www.domesday86.com/wp-content/uploads/2017/01/Philips-VP415-Operating-Instructions.pdf
7. Centre for Computing History: BBC Domesday Preservation Project (online emulator) — http://www.computinghistory.org.uk/pages/8792/BBC-Domesday-System-Preservation/
8. Rhind & Openshaw (1986): 'The BBC Domesday Project: a nation-wide CIS for $4448' (technical report) — https://cartogis.org/docs/proceedings/archive/auto-carto-8/pdf/the-bbc-domesday-project-a-nation-wide-cis-for-$4448.pdf
9. The Guardian / Observer, 3 March 2002: 'Digital Domesday Book lasts 15 years not 1000' — https://www.theguardian.com/uk/2002/mar/03/research.elearning
10. Tim Harford, Cautionary Tales podcast (Nov 2023): 'Laser Versus Parchment' — https://timharford.com/2023/11/cautionary-tales-laser-versus-parchment-doomsday-for-the-disc/
11. Wikimedia Commons: Category:BBC Domesday Project (9 CC-licensed photos by Simon Inns & Paul Downey) — https://commons.wikimedia.org/wiki/Category:BBC_Domesday_Project

---

## Sega Hologram Time Traveler (1991)

**By:** Virtual Image Productions (Rick Dyer) / GTE ImagiTrek; published by Sega Enterprises  
**Tags:** `HCI` `Display` `Holographic` `Laserdisc` `Arcade` `Branching Video` `Time Reversal` `Commercial Failure`
...
![Full Hologram Time Traveler arcade cabinet with backlit 'SEGA Hologram Time Traveler' sign](../assets/wiki/hologram-time-traveler-cabinet.jpg)
*Full Time Traveler arcade cabinet with the tall 'SEGA Hologram Time Traveler' back sign. Public-domain photo (Wikimedia Commons, author Onoff456).*

![Front view of Time Traveler's control panel — the 4-way joystick and two buttons](../assets/wiki/hologram-time-traveler-control-panel.jpg)
*Front view of the control panel: 4-way joystick, action button, and the distinctive 'time reversal' button. Public-domain photo (Wikimedia Commons, author Onoff456).*

### Sources

1. Wikipedia: Time Traveler (video game) — https://en.wikipedia.org/wiki/Time_Traveler_(video_game)
2. Sega Retro: Time Traveler (CC-BY-4.0; release dates, Holosseum replacement note, images) — https://segaretro.org/Time_Traveler
3. Sega Retro: Holosseum (Time Traveler replacement) — https://segaretro.org/Holosseum
4. Weber, Jonathan (1991-07-23). 'Sega Unveils 3-D Holographic Video Game,' Los Angeles Times — https://www.latimes.com/archives/la-xpm-1991-07-23-fi-246-story.html
5. US Patent 4,776,118A: Display device (Goro Mizuno / Decos Co. Ltd, 1988) — Google Patents — https://patents.google.com/patent/US4776118A/en
6. Wikimedia Commons: Category:Hologram Time Traveler (5 public-domain photos) — https://commons.wikimedia.org/wiki/Category:Hologram_Time_Traveler
7. The Arcade Flyer Archive: Sega Time Traveler flyer — https://flyers.arcade-museum.com/?page=thumbs&db=videodb&id=1213
8. Dragon's Lair Project: Time Traveler promotional materials — http://www.dragons-lair-project.com/games/materials/flyers/tt.asp

---

## Milton Bradley Simon (1978)

**By:** Marvin Glass and Associates (Ralph H. Baer & Howard J. Morrison) for Milton Bradley  
**Tags:** `HCI` `Microcontroller` `Audio-Visual` `Memory Game` `Consumer` `Closed-Loop` `TMS1000`
...
![An original 1978 Simon electronic game — circular black disc with four colored translucent quadrant panels (red, blue, green, yellow)](../assets/wiki/simon-game.jpg)
*An original 1978 Simon electronic game — the circular black disc with four colored translucent quadrant panels. CC0 1.0 (public-domain dedication) photo by Shritwod (December 2018), via Wikimedia Commons. The hero image of the Simon Wikipedia article.*

### Sources

1. Wikipedia: Simon (game) — https://en.wikipedia.org/wiki/Simon_(game)
2. Wikipedia: Touch Me (arcade game) — 1974 predecessor — https://en.wikipedia.org/wiki/Touch_Me_(arcade_game)
3. Wikipedia: Howard J. Morrison — https://en.wikipedia.org/wiki/Howard_J._Morrison
4. US Patent 4,207,087A: 'Microcomputer controlled game apparatus' (Baer & Morrison, 1980) — Google Patents — https://patents.google.com/patent/US4207087A/en
5. US Patent 4,207,087 full PDF (USPTO, public domain) — https://patentimages.storage.googleapis.com/28/27/d0/5aaf5b1c4e623c/US4207087.pdf
6. Wikimedia Commons: Simon_Electronic_Game.jpg (CC0 hero photo by Shritwod) — https://commons.wikimedia.org/wiki/File:Simon_Electronic_Game.jpg
7. Wikimedia Commons: Category:Simon (game) — https://commons.wikimedia.org/wiki/Category:Simon_(game)
...
**By:** Susumu Tachi, Mechanical Engineering Laboratory (MEL), Tsukuba, Japan  
**Tags:** `HCI` `Telepresence` `Robotics` `VR` `HMD` `Japan` `Master-Slave`
...
![TELESAR I surrogate anthropomorphic robot under remote operation, building blocks](../assets/wiki/telesar-i-robot.png)
*TELESAR I slave robot under remote operation, building blocks. The anthropomorphic robot has a 7-DOF arm, stereo cameras mounted on a 3-DOF neck, and binaural microphones. Source: Tachi Laboratory, University of Tokyo.*

![General view of the telexistence master-slave manipulation system](../assets/wiki/telesar-i-system.png)
*The full TELESAR I master-slave system: operator (right) wearing the head-coupled stereo display and master arm, and the slave robot (left). Source: Tachi Laboratory, University of Tokyo.*

![Block diagram of the TELESAR I telexistence master-slave manipulation system](../assets/wiki/telesar-i-block-diagram.png)
*Block diagram showing the control architecture with four Intel 286/386 computers managing head tracking, arm control, hand control, and locomotion subsystems. Source: Tachi Laboratory, University of Tokyo.*

### Sources

1. Susumu Tachi Wikipedia — https://en.wikipedia.org/wiki/Susumu_Tachi
2. Tachi Lab: Telexistence overview — https://tachilab.org/en/about/telexistence.html
3. Tachi Lab: TELESAR project page — https://tachilab.org/en/projects/telesar.html
4. Tachi et al., 'Tele-existence (I): Design and Evaluation of a Visual Display with Sensation of Presence,' RoManSy 1984 — https://tachilab.org/content/files/publication/ic/tachi198406RoManSy%282%29.pdf
5. Tachi and Yasuda, 'Evaluation Experiments of a Telexistence Manipulation System,' Presence, Vol.3, No.1, pp.35–44, 1994 — https://tachilab.org/content/files/publication/tp/tachi1994presence.pdf
6. Telepresence Wikipedia (covers telexistence history) — https://en.wikipedia.org/wiki/Telepresence
