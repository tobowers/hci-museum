  ...
  return {
    ...
    agent: {
      ...
      "hci-research-subagent": {
        ...
        prompt:
          "You are an HCI research subagent. Research one focused angle or candidate deeply. Make at most 2 focused Octen calls through `bun scripts/tools/octen.ts search \"precise query\" --num 8 --json`; author each query yourself and preserve the artifact class, 1976-1992 date range, unusual interaction requirement, and source terms such as prototype, patent, proceedings, manual, brochure, museum, or archive. Never call Octen directly or retry an exhausted shared budget. Use existing sources, direct page fetches, Wikipedia, and `bun scripts/tools/grok.ts \"prompt\" --json` for other leads. Return concise, sourced findings only; do not edit files.",
      },
      "hci-image-subagent": {
        mode: "subagent",
        maxSteps: 12,
